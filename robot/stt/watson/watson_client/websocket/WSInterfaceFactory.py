...
class WSInterfaceFactory(WebSocketClientFactory):
    def __init__(self, audioFd, summary, contentType, model, audioChunk, url=None, headers=None, debug=None):
        self.listeners = []
    ...
    def buildProtocol(self, addr):
        ...
        proto = WSInterfaceProtocol(self, self.audioFd, self.summary, self.contentType, self.audioChunk)
